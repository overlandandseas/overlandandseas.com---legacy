export const projects = [
  ...
  },
  {
    ...
    description:
      'Website to get the average color of an image from a url',
  ...
  },
  {
    ...
    description:
      'Electron App used to change the ingame music of KF2',
    date: new Date('2/25/2016')
  },
  {
    title: 'ios App Sorter',
    description:
      'Tool used to sort iOS apps based on color',
  ...
  },
  {
    title: '#!++',
    description:
      'Debain 9 based linux distro, originally based on Crunchbang (#!)',
  ...
  export const writings = [{
    ...
    link:
      'https://gist.github.com/overlandandseas/ad0ac1496865e6f6c390f7928be900c0',
    date: new Date('12/29/2017')
  },
  {
    title: 'Music in 2017',
    description:
      'Writeup on what music I discovered and was listening to in 2017',
